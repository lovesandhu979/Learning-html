...
if (typeof usi_analytics === 'undefined') {
	usi_analytics = {
		...
		usi_app.listen_for_active_cart = function() {
			...
			try {
				if (usi_app.is_cart_page) {
					...
					if (document.querySelector("[data-automation=\"SecondaryItems_shopping-cart_button\"]") != null) {
						if (document.querySelector("[data-automation=\"SecondaryItems_shopping-cart_button\"]").textContent != "") {
							usi_cookies.set("usi_active_cart", "true", 24*60*60, true);
		...
		usi_app.load = function () {
			...
			if (!usi_app.is_existing_customer && usi_app.is_footage_in_cart && !usi_date.is_between('2021-08-26T00:01:00', '2021-09-10T23:59:00')) {
			...
			} else if (!usi_app.is_existing_customer && usi_app.is_footage_in_cart && usi_date.is_between('2021-08-26T00:01:00', '2021-09-10T23:59:00')) {
				// Sitewide events
			...
			if (typeof(usi_app.interval_id) === "undefined") {
				usi_app.interval_id = setInterval(function() {
					...
					if (usi_split_test.get_group(control_site_id) == '1') {
						if (!usi_app.is_existing_customer && !usi_app.is_footage_in_cart && usi_app.is_english
								&& ( (usi_app.is_image() && location.href.indexOf("/purchase") != -1) || usi_app.is_image_in_cart || usi_app.is_image_page ) ) {
